...
public class csp_postgresql_cdc_202211 {
    public static void main(String[] args) throws Exception {
        ...
        TableResult tableResult2 = tableEnv.executeSql("" +
                "CREATE TABLE IF NOT EXISTS `default_catalog`.`postgres`.`public__cs_incident_202211_src` (" +
                "  `id` STRING NOT NULL," +
                ...
                "  'port' = '1922'," +
                "  'password' = '123@prod'," +
                "  'table-name' = 'cs_incident_202211'," +
                "  'hostname' = '172.25.242.245'," +
                "  'username' = 'developer'," +
                "  'database-name' = 'csp_prod_cs'," +
                "  'schema-name' = 'public'," +
                "  'debezium.slot.name' = 'cs_incident_202211'," +
                "  'decoding.plugin.name' = 'wal2json'" +
                ")");

        TableResult tableResult3 = tableEnv.executeSql("CREATE TABLE IF NOT EXISTS `default_catalog`.`postgres`.`public__cs_incident_202211_sink` (" +
                "  `id` STRING NOT NULL," +
                "  `incident_no` BIGINT NOT NULL," +
                "  `type` STRING NOT NULL," +
                "  `process_type` STRING NULL," +
        ...
        TableResult tableResult4 = tableEnv.executeSql("INSERT INTO `default_catalog`.`postgres`.`public__cs_incident_202211_sink` " +
                "SELECT * FROM `default_catalog`.`postgres`.`public__cs_incident_202211_src`");


        TableResult tableResult5 = tableEnv.executeSql("" +
                "CREATE TABLE IF NOT EXISTS `default_catalog`.`postgres`.`public__cs_incident_process_202211_src` (" +
                "  `id` STRING NOT NULL," +
                "  `incident_no` BIGINT NOT NULL," +
                ...
                "  'port' = '1922'," +
                "  'password' = '123@prod'," +
                "  'table-name' = 'cs_incident_process_202211'," +
                "  'hostname' = '172.25.242.245'," +
                "  'username' = 'developer'," +
                "  'database-name' = 'csp_prod_cs'," +
                "  'schema-name' = 'public'," +
                "  'debezium.slot.name' = 'cs_incident_process_202211'," +
                "  'decoding.plugin.name' = 'wal2json'" +
                ")");

        TableResult tableResult6 = tableEnv.executeSql("" +
                "CREATE TABLE IF NOT EXISTS `default_catalog`.`postgres`.`public__cs_incident_process_202211_sink` (" +
                "  `id` STRING NOT NULL," +
                "  `incident_no` BIGINT NOT NULL," +
                "  `process_type` STRING NOT NULL," +
                "  `role` STRING NOT NULL," +
        ...
        TableResult tableResult7 = tableEnv.executeSql("INSERT INTO `default_catalog`.`postgres`.`public__cs_incident_process_202211_sink` " +
                " SELECT * FROM `default_catalog`.`postgres`.`public__cs_incident_process_202211_src`");

        tableResult7.print();
        env.execute("csp_postgresql_cdc_202211");
    }
}